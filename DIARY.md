...
Bypassed by temporarily switching the host machine to an external mobile hotspot and downloading both the small (500 records) dataset and the full dataset (~60MB).
